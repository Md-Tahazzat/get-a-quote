...
const UpdateHeroService: React.FC<ClientUpdateModalProps> = ({ client, updateModal, onClose, getClient }) => {
  ...
  const handleUpdate = async (id: string) => {
    ...
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_URL}/api/dashboard/home/homeService/${id}`, {
        method: 'PUT',
        headers: {
