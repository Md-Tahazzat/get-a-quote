...
const AddAboutModal: React.FC<AddModalProps> = ({ closeModal, isModalOpen, getAbout}) => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch(`${process.env.NEXT_PUBLIC_URL}/api/dashboard/home/about`, {
        method: 'POST',
        headers: {
