...
import AboutAddModal from "./About-add-modal/AboutAddModal";
import AboutUpdateModal from "./About-UpdateModal/AboutUpdateModal";
   ...
   const getAbout = async () => {
    try {
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_URL}/api/dashboard/about/abouthero`
      );
  ...
  const handleDelete = async (id: string) => {
    try {
      ...
      if (result.isConfirmed) {
        ...
        const response = await fetch(
          `${process.env.NEXT_PUBLIC_URL}/api/dashboard/about/abouthero/${id}`,
          {
            method: "DELETE",
          }
        );
    ...
    <>
      ...
      <section className="container px-4 mx-auto mt-10">
        <div className="flex items-center justify-between gap-x-3">
          <h2 className="text-3xl font-medium ">Hero About</h2>
          <button
            onClick={openModal}
                        ...
                        <>
                          ...
                          <tr>
                            <td className="px-4 py-4 ">
                              ...
                              <Image width={50} height={50} src={about?.AboutImage} alt="hero-about-image"></Image>
